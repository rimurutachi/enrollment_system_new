...
import styles from "../../styles/AdminStudentMasterlist.module.css";
import Sidebar from "../../components/Admin/Sidebar.jsx";

const AdminStudentMasterlist = () => {
      ...
      {isModalOpen && selectedStudent && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            ...
            <p>
              <strong>Full Name:</strong> {selectedStudent.firstName}{" "}
            ...
            <p>
              <strong>Contact Number:</strong> {selectedStudent.contact}
            </p>
